...
function Dashboard() {
  ...
  useEffect(() => {
    load(1);
  }, [search, fDepartment, fDesignation, fStatus]);
  ...
  const handleRefresh = async () => {
    ...
    setTimeout(() => setRefreshText('Refresh'), 1200);
  };
  ...
  const handleChangePassword = async (e) => {
    ...
    if (passForm.password !== passForm.password_confirmation) {
      alert('New password and confirmation do NOT match — retype both.');
      return;
    }
    ...
    <div style={{ padding: '20px' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
          ...
          <button onClick={exportPDF} style={btn('#dc2626')}>
            Export PDF
          </button>
          <button
            onClick={handleRefresh}
            disabled={refreshDisabled}
            style={{ ...btn('#e2e8f0'), color: '#1e293b' }}
          >
            {refreshText}
          </button>
          <button onClick={() => setShowPass(true)} style={{ ...btn('#e2e8f0'), color: '#1e293b' }}>
            Change Password
          </button>
      ...
      {stats && (
        ...
        >
          <div style={{ background: '#fff', padding: '20px', borderRadius: '8px', textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '28px', fontWeight: '700' }}>{stats.total_employees}</div>
          </div>
          <div
            style={{
              background: '#fff',
          ...
          >
            ...
            <div style={{ fontSize: '28px', fontWeight: '700', color: '#2563eb' }}>{stats.total_users}</div>
          </div>
          <div
            style={{
              background: '#fff',
          ...
          >
            ...
            <div style={{ fontSize: '28px', fontWeight: '700', color: '#ea580c' }}>
              ${Number(stats.monthly_payroll || 0).toLocaleString()}
            </div>
          </div>
        </div>
      )}
      ...
      <div style={{ overflowX: 'auto' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', background: '#fff' }}>
          <thead style={{ background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
            <tr>
              {['ID', 'Emp #', 'Name', 'Email', 'Department', 'Position', 'Type', 'Salary', 'Status', 'Actions'].map(
                (h) => (
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '20px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '12px', color: '#64748b' }}>
                  ...
                  <span
                    style={{
                      color: viewing.status === 'Active' ? '#16a34a' : '#dc2626',
                      fontWeight: '600',
                    }}
                  >
                    {viewing.status}
